...
$(function () {
    ...
    $(window).on('load', function () {
        ...
        setTimeout(function () {
            console.log("Fading out .page_loader");
            $(".page_loader").fadeOut("fast");
        }, 100);

        if ($('body .filter-portfolio').length > 0) {
            console.log("Initializing filter-portfolio");
    ...
    // Set the left sidebar's min-height to window's height
    ...
    if ($.fn.magnificPopup) {
        ...
        console.warn("Magnific Popup plugin not loaded.");
    }
    ...
    if ($.fn.lightGallery) {
        ...
        console.warn("lightGallery plugin not loaded.");
    }
    ...
    // Header adjustments and sticky behavior
    adjustHeader();
    doSticky();
    placedDashboard();
    ...
    // Banner slider with animated captions
    (function ($) {
    ...
    // Page scroller initialization using scrollUp
    if ($.fn.scrollUp) {
        $.scrollUp({
        ...
        console.warn("scrollUp plugin not loaded.");
    }

    // Counter animation when elements become visible
    ...
    $(function () {
        ...
        if ($.fn.countdown) {
            ...
            console.warn("Countdown plugin not loaded.");
        }
    });
    ...
    if ($.fn.selectpicker) {
        ...
        console.warn("selectpicker plugin not loaded.");
    }
    ...
    $(document).ready(function () {
        if ($.fn.mb_YTPlayer) {
            ...
            console.warn("mb_YTPlayer plugin not loaded.");
        }
    });

    // Multilevel menu activation
    $('[data-submenu]').submenupicker();

    // Expanding/Collapsing advanced search content
    $('.show-more-options').on('click', function () {
        $(this).find('.fa').toggleClass('fa-minus-circle fa-plus-circle');
    });

    // Adjust sidebar widget video height
    ...
    // Dropdown activation for nested dropdowns
    ...
    // Filterizr initialization (if needed)
    $(function () {
        // Uncomment if you want to initialize filterizr:
